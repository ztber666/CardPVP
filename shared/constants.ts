...
export const CARDS: CardTemplate[] = [
  ...
  {
    id: 'card_2', name: '烟花', icon: '4,1', weight: 20,
    costType: CostType.Action,
    effects: [eff(BuffType.PhysicalDamage, 5)],
    description: '5点物理伤害',
  },
  {
    id: 'card_3', name: '龙息', icon: '4,1', weight: 6,
    costType: CostType.Action,
    effects: [
  ...
  {
    id: 'card_4', name: '金苹果', icon: '3,1', weight: 6,
    costType: CostType.Action,
    effects: [
  ...
  {
    id: 'card_5', name: '火把', icon: '5,2', weight: 5,
  ...
  {
    id: 'card_6', name: '灯笼', icon: '5,2', weight: 5,
    costType: CostType.Strategy,
    effects: [
  ...
  {
    id: 'card_8', name: '灵魂火把', icon: '6,2', weight: 5,
    costType: CostType.Strategy,
    effects: [
  ...
  {
    id: 'card_9', name: '灵魂灯笼', icon: '6,2', weight: 5,
    costType: CostType.Strategy,
    effects: [
  ...
  {
    id: 'card_10', name: '刷怪笼', icon: '4,1', weight: 4,
    costType: CostType.Action,
  ...
  {
    id: 'card_12', name: '发光浆果', icon: '5,2', weight: 3,
    costType: CostType.Strategy,
    effects: [eff(BuffType.HealBoost, 2, 2)],
    description: '治愈增强+2层[*2]',
  },
  {
    id: 'card_13', name: '水桶', icon: '5,6,2', weight: 2,
    costType: CostType.Strategy,
    effects: [],
  ...
  },
  {
    ...
    costType: CostType.Strategy,
    effects: [eff(BuffType.Block, 1, 2)],
    description: '目标获得2回合「格挡」',
  },
  {
    id: 'card_16', name: '望远镜', icon: '7,2', weight: 2,
    costType: CostType.Strategy,
    effects: [eff(BuffType.RevealHand, 10)],
    description: '目标展示所有手牌给出牌者',
  },
  {
    id: 'card_17', name: '萝卜钓竿', icon: '7,2', weight: 5,
    costType: CostType.Strategy,
    effects: [eff(BuffType.StealCard, 1)],
    description: '抽取目标一张手牌并获得',
  },
  {
    id: 'card_18', name: '诡异钓竿', icon: '7,2', weight: 4,
    costType: CostType.Strategy,
    effects: [],  // 效果在弹窗中处理
  ...
  {
    id: 'card_30', name: '酿造台', icon: '9', weight: 1,
    costType: CostType.Weapon,
    effects: [],
  ...
  {
    id: 'card_37', name: '附魔台', icon: '7,11', weight: 2,
  ...
  {
    id: 'card_39', name: '烈焰粉', icon: '11', weight: 5,
    costType: CostType.Counter,
    effects: [],
